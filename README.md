...
The dataset was based on a NIH ChestXray dataset available on Kaggle. Due to size restrictions, the images are not included in this repository.
...
4.	**Model development**. Two CNN models: ≤6 convolutional layers, pooling layers, 2 fully connected layers, >60K trainable parameters, sigmoid output layer.
5.	**Evaluation and comparison**: performance metrics, ROC curve analysis and confusion matrix.

## 📚 Key results
- Model 1 achieved a higher AUC (0.89), with its ROC curve closer to the top left corner of the graph.
- Model 1 showed higher precision (0.79), although Model 2 produced less false negatives.

<img src="https://github.com/arnaumariscal/Chest-X-Ray-Classification-using-CNNs/blob/main/results/roc_curve.png" alt="Sample Image" width="650" height="500">
